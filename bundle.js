...
module.exports = function (attrs) {
  return html(_templateObject, box, gridDisplay, cardTitleStyle, attrs.name, contentStyle, attrs.image, infoStyle, attrs.price, attrs.vintage);
};
  ...
  switch (store.results.status) {
    ...
    case 'LOADED':
      ...
      return store.results.wineResults.map(function (wineResult) {
        return html(_templateObject, wineResult.name, wineResult.image, wineResult.price, wineResult.vintage);
      });
    default:
      return 'Error...';
  }
