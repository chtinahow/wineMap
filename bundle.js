...
var apiKey = 'dm2umigp683o6ied149g1hdckyn0vyf9zpjkqqg4x7ny1qee';
...
module.exports = {
  ...
  fetchWineResults: function fetchWineResults(state, searchParameters, actions) {
    ...
    fetch('http://api.snooth.com/wines/?akey=' + apiKey + '&' + wineParams).then(function (data) {
      return data.json();
    }).then(function (data) {
...
},{"./actions/enable-actions":1,"./actions/wine-actions":2,"./pages/home":5,"./pages/results":6,"tram-one":4}],4:[function(require,module,exports){
(function (global){
...
module.exports = function (store, actions) {
  return html(_templateObject, !store.enabled["Wine Name"], actions.enable, actions.disable, actions.setSearchParam, store.enabled["Wine Name"], !store.enabled["Vintage"], actions.enable, actions.disable, !store.enabled["Color"], actions.enable, actions.disable, ['Red', 'White', 'Rose', 'Amber', 'Clear'], store.enabled["Color"], actions.setSearchParam, !store.enabled["Price"], actions.enable, actions.disable, !store.enabled["Country"], actions.enable, actions.disable, actions.setSearchParam, store.enabled["Country"], store.enabled['Country'] === 'US' ? 'selected' : '', store.enabled['Country'] === 'AR' ? 'selected' : '', store.enabled['Country'] === 'AU' ? 'selected' : '', store.enabled['Country'] === 'AT' ? 'selected' : '', store.enabled['Country'] === 'BE' ? 'selected' : '', store.enabled['Country'] === 'CA' ? 'selected' : '', store.enabled['Country'] === 'DK' ? 'selected' : '', store.enabled['Country'] === 'SV' ? 'selected' : '', store.enabled['Country'] === 'EE' ? 'selected' : '', store.enabled['Country'] === 'FR' ? 'selected' : '', store.enabled['Country'] === 'DE' ? 'selected' : '', store.enabled['Country'] === 'GB' ? 'selected' : '', store.enabled['Country'] === 'HK' ? 'selected' : '', store.enabled['Country'] === 'HU' ? 'selected' : '', store.enabled['Country'] === 'IE' ? 'selected' : '', store.enabled['Country'] === 'IT' ? 'selected' : '', store.enabled['Country'] === 'JP' ? 'selected' : '', store.enabled['Country'] === 'MY' ? 'selected' : '', store.enabled['Country'] === 'MT' ? 'selected' : '', store.enabled['Country'] === 'NL' ? 'selected' : '', store.enabled['Country'] === 'NZ' ? 'selected' : '', store.enabled['Country'] === 'NO' ? 'selected' : '', store.enabled['Country'] === 'PL' ? 'selected' : '', store.enabled['Country'] === 'PT' ? 'selected' : '', store.enabled['Country'] === 'PR' ? 'selected' : '', store.enabled['Country'] === 'RU' ? 'selected' : '', store.enabled['Country'] === 'SG' ? 'selected' : '', store.enabled['Country'] === 'ES' ? 'selected' : '', store.enabled['Country'] === 'CH' ? 'selected' : '', store.enabled['Country'] === 'UK' ? 'selected' : '');
};

},{"../search-card-components/search-dropdown":8,"../search-card-components/search-input":9,"../search-card-components/search-options":10,"../search-card-components/search-range":11,"tram-one":4}],6:[function(require,module,exports){
'use strict';
...
module.exports = function (store, actions, params) {
  ...
  return html(_templateObject, drinkDOM);
};

},{"tram-one":4}],7:[function(require,module,exports){
'use strict';
...
},{"tram-one":4}],8:[function(require,module,exports){
'use strict';
...
},{"./search-card":7,"tram-one":4}],9:[function(require,module,exports){
'use strict';
...
},{"./search-card":7,"tram-one":4}],10:[function(require,module,exports){
'use strict';
...
},{"./search-card":7,"tram-one":4}],11:[function(require,module,exports){
'use strict';
...
module.exports = function (attrs) {
  return html(_templateObject, attrs.title, attrs.disabled, attrs.onenable, attrs.ondisable);
};

},{"./search-card":7,"tram-one":4}]},{},[3]);
